...
public class PMO_Test {
    ...
    private void testGet(List<Point> expected) {
        ...
        assertNotNull(result, "Wynikiem metody get nie moĹźe byÄ null");
        assertIterableEquals(expected, result, "NiezgodnoĹÄ wyniku get z oczekiwanym");
    }

    private void testUniq(List<Point> expected) {
        List<Point> result = getUniq();
        assertNotNull(result, "Wynikiem metody getUniq nie moĹźe byÄ null");
        assertIterableEquals(expected, result, "NiezgodnoĹÄ wyniku getUniq z oczekiwanym");
    }

    private void testMap(Map<Point, Integer> expected) {
        Map<Point, Integer> result = getPointsAsMap();
        assertNotNull(result, "Wynikiem metody getPointsAsMap nie moĹźe byÄ null");

        assertEquals(expected.size(), result.size(), "Oczekiwano innej liczby elementĂłw w mapie getPointsAsMap");

        expected.entrySet().forEach(e -> {
            assertTrue(result.containsKey(e.getKey()), "Oczekiwano, Ĺźe w mapie jest klucz " + e.getKey());
            assertEquals(e.getValue(), result.get(e.getKey()), "Oczekiwano innej wartoĹci dla klucza " + e.getKey());
        });
    }
    ...
    @Test
    @DisplayName("Test bĹÄdnego remove")
    ...
    public void removeResult() {
        add(List.of(p1, p2, p1, p1, p3, p4, p3, p3, p6));
        assertTrue(remove(p6), "UsuniÄcie istniejÄcego punktu powinno zwrĂłciÄ true");
        assertFalse(remove(p7), "UsuniÄcie nieistniejÄcego punktu powinno zwrĂłciÄ false");
    }

    @Test
    @DisplayName("Test remove - powtĂłrzenia elementĂłw")
    ...
    @Test
    @DisplayName("Test bĹÄdnego wywoĹania addAfter")
    ...
    public void addAfterResult() {
        add(List.of(p1, p2, p1, p1, p3, p4, p3, p3, p6));
        assertTrue(addAfter(p1, p6), "PrawidĹowe wywoĹanie addAfter powinno zwrĂłciÄ true");
        assertFalse(addAfter(p1, p5), "BĹÄdne wywoĹanie addAfter powinno zwrĂłciÄ false");
    }

    @Test
    @DisplayName("Test addAfter z powtĂłrzeniami")
    ...
    @Test
    @DisplayName("Test bĹÄdnego wywoĹania addBefore")
    ...
    public void addBeforeResult() {
        add(List.of(p1, p2, p1, p1, p3, p4, p3, p3, p6));
        assertTrue(addAfter(p1, p6), "PrawidĹowe wywoĹanie addBefore powinno zwrĂłciÄ true");
        assertFalse(addAfter(p1, p5), "BĹÄdne wywoĹanie addBefore powinno zwrĂłciÄ false");
    }

    @Test
    @DisplayName("Test addBefore z powtĂłrzeniami")
    ...
    @Test
    @DisplayName("Test removeBefore z powtĂłrzeniami")
    ...
    public void removeBeforeResult() {
        ...
        assertNotNull(result, "Przy prawidĹowych danych removeBefore nie moĹźe zwrĂłciÄ NULL");
        assertEquals(p3, result, "PrawidĹowe dane - oczekiwano innego wyniku removeBefore");

        result = removeBefore(p7);
        assertNull(result, "removeBefore - wskazano nieistniejÄcy punkt - wynikiem powinien byÄ NULL");
        result = removeBefore(p1);
        assertNull(result, "removeBefore - przed wskazanym punktem nie punktu do usuniÄcia - wynikiem ma byÄ NULL");
    }
    ...
    @Test
    @DisplayName("Test removeAfter z powtĂłrzeniami")
    ...
    public void removeAfterResult() {
        ...
        assertNotNull(result, "Przy prawidĹowych danych removeAfter nie moĹźe zwrĂłciÄ NULL");
        assertEquals(p3, result, "PrawidĹowe dane - oczekiwano innego wyniku removeAfter");

        result = removeAfter(p5);
        assertNull(result, "removeAfter - wskazano nieistniejÄcy punkt - wynikiem powinien byÄ NULL");
        result = removeAfter(p6);
        assertNull(result, "removeAfter - za wskazanym punktem nie punktu do usuniÄcia - wynikiem ma byÄ NULL");
    }
    ...
    @Test
    @DisplayName("Test addBefore + undo - bĹÄdne addBefore")
    ...
    @Test
    @DisplayName("Test bĹÄdnego removeBefore + undo")
